...
@section("content")
    <div class="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0b1026] via-[#0c1430] to-[#090f24]">
        ...
        <div class="pointer-events-none absolute -bottom-32 left-16 h-96 w-96 rounded-full bg-indigo-500/20 blur-[160px]">
        </div>
            ...
            <div
                ...
                <div class="grid gap-0 lg:grid-cols-2">
                    <section
                        ...
                        <div
                            class="pointer-events-none absolute -left-20 top-6 h-56 w-56 rounded-full bg-blue-400/20 blur-3xl">
                        </div>
                        <div
                            class="pointer-events-none absolute -bottom-24 right-6 h-72 w-72 rounded-full bg-indigo-500/20 blur-[120px]">
                        </div>
                                ...
                                <form action="{{ route('login') }}" method="POST" class="mt-5 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="password" id="login-password" name="password"
                                            class="mt-2 block w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
                                    ...
                                    <p class="text-center text-xs text-slate-500">
                                        ...
                                        <a href="{{ url('/') }}" class="font-semibold text-blue-600 hover:underline">Sign
                                            up</a>
                                    </p>
                                </form>
                            </div>
